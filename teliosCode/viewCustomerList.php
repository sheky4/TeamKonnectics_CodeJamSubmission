		...
		
	{
		...
		while($row = mysql_fetch_object($sql)){
			...
			<tr>
				...
				<td><a href="editCustomerItem.php?ItemID=<?php echo $row->itemID; ?>&ItemQuantity=<?php echo $row->quantity;?>&itemName=<?php echo $row->itemName;?>&listID=<?php echo $listID; ?>"><img src="images/editBtn.png" alt="Edit" class="img"/></a></td>
				
				<td><a href="#"  data-item ="<?php echo $row->itemID?>" class="delete"><img src="images/deleteBtn.png" alt="Edit" class="img"/></a></td>
...
<!DOCTYPE html>
 ...
 <legend class = "red medium design">Add Items to List</legend>
  ...
  if(isset($_GET['successMsg'])){ 
										...
										echo"<span class='errorMessage'> Your list has been sent to the grocery successfully.</span>";
 ...
 ?>
	 <table id = "data">
			...
			<tr><td><input type="button" class="btn btn-danger" value="Save" id="save"></td><tr>

<tr><td> <form name="createList1" method="post" action="groceryPage.php?listID=<?php echo $listID; ?>" >
				
				<button type="submit" class = "btn btn-danger" role = "button">Send List To Grocery</button>
