...
<body>
	<div class="container">
		...
		<ul class="breadcrumb">
			...
			<li ><a class="red" href="#">Past Unfulfilled Orders</a></li>
	...
	<div class="row">
                <div class="col-lg-12"> 
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <h1 class="red center">Past Unfulfilled Orders</h1>
									<br/>
						...
						$stmt = mysqli_prepare($mysqli, "SELECT list.listID, list.listDate, list.customerID, list.status FROM list WHERE status = ? AND groceryID = ? AND listDate != ? and groceryAccess = 'yes'
			...
			/* store result */
				...
				if($test ==0)
				{
					echo"<span class='errorMessage'> There are no unfulfilled orders.</span>";
				}
				else if($test != 0)
				{
  ...
  <tr>
    ...
    <td>$customerID</td>
    <td>$status</td>
     <td><a href='viewPastOrder.php?list_id=$listID'>View Order </a></td>
  </tr>
