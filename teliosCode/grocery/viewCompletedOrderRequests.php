	...
	<div class="row">
                <div class="col-lg-12"> 
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <h1 class="red center">Completed Orders</h1>
									<br/>
						...
						$stmt = mysqli_prepare($mysqli, "SELECT list.listID, list.listDate, list.customerID, list.status FROM list WHERE status != ? AND groceryID = ? and groceryAccess = 'yes' ORDER BY list.listDate ");
						if ($stmt) 
						{
							
				mysqli_stmt_bind_param($stmt, "si", $orderStatus, $groceryID);
			...
			/* store result */
				...
				if($test ==0)
				{
					echo"<span class='errorMessage'> There are no completed orders.</span>";
				}
				else if($test != 0)
				{
