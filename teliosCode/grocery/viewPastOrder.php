...
echo $list_id =  $_GET['list_id'];
  ...
  if(isset($_POST['lateNotification'])){ 
	Header("Location:lateNotificationPast.php?list_id=$list_id");
  }
 ...
 if(isset($_POST['fulfillOrder'])){ 
	...
	include("../services/databaseConnection.php");
			...
			if ($stmt = mysqli_prepare($mysqli, "UPDATE list SET status = ?, triggered = 1 WHERE list.listID = ?;")) 
			{
				...
				Header("Location:viewPastUnfulfilledOrders.php?fulfilment=success");
...
<body>
	<div class="container">
		...
		<ul class="breadcrumb">
			...
			<li ><a  href="viewPastUnfulfilledOrders.php">Past Unfulfilled Orders</a></li>
			<li ><a class="red" href="#">Past Unfulfilled Order</a></li>
	...
	<div class="row">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12 center">
                                    ...
                                    <h1 class="red center">Past Unfulfilled Order</h1>
									<br/>
										<?php
						include("../services/databaseConnection.php");
			...
			/* store result */
				...
				if($test ==0)
				{
					$errorMessage = " There are no past orders to be fulfilled";
				}
				else if($test != 0)
				{
...
";
			...
			mysqli_stmt_close($stmt);
					...
					<?php
						...
						//create a prepared statement
						$stmt = mysqli_prepare($mysqli, "SELECT item.itemName, listItems.quantity FROM list, listItems, item WHERE list.listID = listItems.listID AND list.listID = ? and listItems.itemID = item.itemID AND list.groceryID = ?  AND status = ? 
				...
				mysqli_stmt_bind_param($stmt, "iis", $list_id, $groceryID, $orderStatus);
			...
			/* store result */
				...
				if($test ==0)
				{
					echo"<span class='errorMessage'> There are no past orders to be fulfilled.</span>";
				}
				else if($test != 0)
				{
...
?> 
					...
					<br/>
					<br/>
						<form name="fulfillOrder1" method="post"  >
